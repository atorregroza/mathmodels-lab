      ...
      <header className="sticky top-0 z-40 border-b border-ink/10 bg-paper/88 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 md:px-8">
          ...
          <nav className="hidden items-center gap-3 md:flex">
            ...
            <NavLink
              to="/calculadora"
              className="flex items-center gap-1.5 rounded-full bg-aqua/10 px-3 py-1.5 text-xs font-semibold text-aqua transition-colors hover:bg-aqua/20"
              title="Calculadora"
            >
      ...
      <footer className="relative z-10 border-t border-ink/10 bg-white/65">
        <div className="mx-auto max-w-7xl px-5 py-8 md:px-8">
          ...
          <div className="mt-4 pt-4 border-t border-ink/6 flex flex-col gap-2 text-xs text-ink/45 md:flex-row md:items-center md:justify-between">
            ...
            <NavLink to="/feedback" className="inline-flex items-center gap-1.5 rounded-full bg-aqua/10 px-3 py-1.5 text-xs font-semibold text-aqua transition-colors hover:bg-aqua/20">
